...
const Taskadd = () => {
  ...
  return (
    ...
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      <Paper elevation={3} sx={{ p: 3,  borderRadius: 2 , width:"605px",
            height:"350px",
            position:"absolute",
            top:"620px",
            left:"303px",
        ...
        <Box display="flex" justifyContent="space-between" alignItems="center" mb={2} >
          ...
          <Box display="flex" gap={2} alignItems="center">
            ...
            <Box display="flex" alignItems="center" sx={{
              px: 2, py: 1, borderRadius: 2, border: '2px solid #6B4FC8',
        ...
        {taskList.map((task, index) => (
          <Box key={index} display="flex" alignItems="center" border="1px solid #E0E0E0" borderRadius={1} mb={2}  >
            <Box sx={{ width: '5px', backgroundColor: task.color, height: '40px', borderTopLeftRadius: 4, borderBottomLeftRadius: 4,  }} />
            ...
            >
              {colorOptions.map((color, idx) => (
                <MenuItem key={idx} value={color}>
                  <Box sx={{ display: 'inline-block', width: 20, height: 20, backgroundColor: color, mr: 1 }} />
                  {color}
                </MenuItem>
              ))}
            </Select>
